...
def upgrade() -> None:
    ...
    op.create_index(
        "case_workspace_import", "cases", ["workspace_id", "import_digest"], unique=True
    )
    op.create_index(
        "case_workspace_mismatch",
        "cases",
        ["workspace_id", "has_mismatch"],
        unique=False,
    )
    op.create_index(
        "case_workspace_received",
        "cases",
        ["workspace_id", "received_at"],
        unique=False,
    )
    op.create_index(
        "case_workspace_review", "cases", ["workspace_id", "needs_review"], unique=False
    )
    op.create_index(
        op.f("ix_cases_workspace_id"), "cases", ["workspace_id"], unique=False
    )
    op.create_table(
        "counters",
    ...
    op.create_index(
        op.f("ix_reservations_run_id"), "reservations", ["run_id"], unique=False
    )
    op.create_table(
        "runs",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_workspaces_expires_at"), "workspaces", ["expires_at"], unique=False
    )
