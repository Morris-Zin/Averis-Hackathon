...
export function Select({ value, onValueChange, label, children, disabled }: { value: string; onValueChange: (value: string) => void; label: string; children: ReactNode; disabled?: boolean }) {
  return (
...
export function Spinner({ label = "Loading" }: { label?: string }) {
  return <span className="spinner" role="status"><span className="spinner-mark" aria-hidden="true" />{label}</span>;
}
